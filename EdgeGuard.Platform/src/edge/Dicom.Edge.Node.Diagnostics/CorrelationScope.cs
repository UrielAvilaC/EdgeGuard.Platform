...
/// <code>
/// using (CorrelationScope.Start("my-correlation-id"))
/// {
///     // All logs emitted here will include the correlation ID
///     logger.LogInformation("Processing study...");
/// }
/// </code>
/// </remarks>
public sealed class CorrelationScope : IDisposable
{
    ...
    /// </summary>
    /// <param name="correlationId">The correlation ID. If null, a new GUID is generated.</param>
