namespace Dicom.Edge.Node.Diagnostics.Configuration;

/// <summary>
/// Root configuration options for Edge Node diagnostics, logging, health checks,
/// metrics and PHI redaction.
/// </summary>
public sealed class DiagnosticsOptions
{
    ...
    /// <summary>
    /// Unique identifier for this Edge Node instance.
    /// Defaults to machine name if not set.
    /// </summary>
    public string NodeId { get; set; } = global::System.Environment.MachineName;

    /// <summary>
    /// Application name used in log enrichment and telemetry.
    /// </summary>
    public string Application { get; set; } = "EdgeNode";

    /// <summary>
    /// Logical component name (e.g., DicomServer, Sender, Queue).
    /// </summary>
    ...
    /// <summary>
    /// HTTP sink configuration for generic log shipping.
    /// </summary>
...
/// <summary>
/// File-based logging sink configuration.
/// </summary>
public sealed class FileLoggingOptions
{
    ...
    /// <summary>
    /// Log file name template. Supports Serilog date tokens.
    /// </summary>
    public string FileNameTemplate { get; set; } = "edge-node-.log";
    ...
    /// <summary>
    /// Maximum number of retained log files. Null for unlimited.
    /// </summary>
    ...
    /// <summary>
    /// Whether to use compact JSON formatting.
    /// </summary>
    public bool UseCompactJson { get; set; } = true;
}

/// <summary>
/// Seq centralized logging sink configuration.
/// </summary>
public sealed class SeqOptions
{
    /// <summary>
    /// Whether the Seq sink is enabled.
    /// </summary>
    ...
    /// <summary>
    /// Seq API key for authentication.
    /// </summary>
    public string? ApiKey { get; set; }
}

/// <summary>
/// HTTP sink configuration for shipping logs to a remote endpoint.
/// </summary>
public sealed class HttpSinkOptions
{
    /// <summary>
    /// Whether the HTTP sink is enabled.
    /// </summary>
    public bool Enabled { get; set; }
    ...
    /// <summary>
    /// Batch size for HTTP log shipping.
    /// </summary>
    public int BatchPostingLimit { get; set; } = 1000;

    /// <summary>
    /// Period in seconds between batch posts.
    /// </summary>
...
public sealed class OpenTelemetryOptions
{
    ...
    /// </summary>
    public string ServiceName { get; set; } = "EdgeNode";
...
public sealed class PrometheusOptions
{
    ...
    /// <summary>
    /// Endpoint path for Prometheus scraping.
    /// </summary>
    public string Endpoint { get; set; } = "/metrics";
}

/// <summary>
/// PHI (Protected Health Information) redaction configuration.
/// </summary>
public sealed class PhiRedactionOptions
{
    /// <summary>
    /// Whether PHI redaction is enabled. Enabled by default in Production.
    /// </summary>
    public bool Enabled { get; set; } = true;

    /// <summary>
    /// Redaction mode: Strict (production) or Relaxed (development).
    /// </summary>
    ...
    /// <summary>
    /// Property names that must always be redacted.
    /// </summary>
    ...
    /// <summary>
    /// Regex patterns to detect and redact PHI in log messages.
    /// </summary>
...
/// <summary>
/// Redaction strictness mode.
/// </summary>
public enum RedactionMode
{
    /// <summary>
    /// Strict mode: all PHI properties and patterns are redacted.
    /// Recommended for production environments.
    /// </summary>
    Strict,

    /// <summary>
    /// Relaxed mode: only explicitly listed properties are redacted.
    /// Suitable for development environments with synthetic data.
    /// </summary>
    Relaxed
}
...
public sealed class HealthCheckThresholdOptions
{
    ...
    /// <summary>
    /// Maximum queue depth before reporting degraded.
    /// </summary>
    public int QueueMaxPendingItems { get; set; } = 1000;

    /// <summary>
    /// Timeout in seconds for PACS connectivity check.
    /// </summary>
    public int PacsTimeoutSeconds { get; set; } = 10;
}
