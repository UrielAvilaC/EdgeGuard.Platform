        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    patient_phone = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    patient_email = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    patient_sex = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    patient_birth_date = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    birth_date = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: true),
