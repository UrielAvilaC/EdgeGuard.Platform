...
public interface IHl7MessageRepository
{
    ...
    /// <summary>
    /// Deletes messages older than the specified cutoff date in batches. Returns the count deleted.
    /// </summary>
    Task<int> DeleteOlderThanAsync(DateTime cutoff, int batchSize = 1000, CancellationToken cancellationToken = default);
}
